...
$stmt = mysqli_prepare($connection, $doc_num_query);
mysqli_stmt_execute($stmt);

$doc_info = mysqli_stmt_get_result($stmt);
...
<?php include 'sidebar.php'; ?>
    <div class="content">
        ...
        <div class="box-header">
            <h3 class="eval-head-text">
                <div class="head">
                <div class="head1">Name of Instructor: <?php echo $facultyName; ?> </div><div class="head2"><?php echo $docnum['name']; echo $docnum['month']; echo $docnum['year'];?></div>
                </div>
