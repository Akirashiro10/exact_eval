...
<head>
  ...
  <style>
    ...
    z-index: 999; /* Ensure overlay is just below the popup */
}
    .overlay2 h2 {
      left: 100px;
    }
...
<script>
  ...
  var url = `student_print.php?search=${encodeURIComponent(searchInput)}&course=${encodeURIComponent(courseFilter)}&section=${encodeURIComponent(sectionFilter)}`;
