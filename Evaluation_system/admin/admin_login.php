...
$stmt = $pdo->prepare("SELECT * FROM active_sessions WHERE course = :course");
$stmt->execute([':course' => 'admin']);
$adminSession = $stmt->fetch();

if ($adminSession) {
    $_SESSION['username'] = $adminSession['user_id'];
        ...
        <div class="evaluation">
            ...
            <div class="form-container">
                <form id="loginForm" method="post" action="">
                    ...
                    <i class="fas fa-user-cog"></i> Username:<input type="text" id="username" name="username" placeholder="Username" maxlength="30" autocomplete="off" required><br>
