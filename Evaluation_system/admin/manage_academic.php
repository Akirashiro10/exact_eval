...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_academic_year'])) {
    ...
    if ($update_stmt->execute()) {
        ...
        echo "<h3 class='below-title'>Error updating academic year details: " . $connection->error . "</h3>";
    }
}
...
$faculty_query = "
    ...
    FROM facultymembers
    JOIN facultymembers ON facultymembers.FacultyID = facultymembers.FacultyID
    JOIN academic_list ON academic_list.academic_year = academic_list.id
