...
<?php include 'sidebar.php'; ?>
  <div class="content">
    ...
    if ($result && mysqli_num_rows($result) > 0) {
      ...
      $total_evaluations_query = "
        ...
        WHERE subjects.FacultyID IN (
            SELECT FacultyID FROM facultymembers WHERE academic_year = $academic_year_id
        )
      ";
    ...
    $faculty_query = "SELECT COUNT(*) AS total_faculty FROM facultymembers WHERE id = $academic_year_id";
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('Overall Average Ratings:', averageRatings);
