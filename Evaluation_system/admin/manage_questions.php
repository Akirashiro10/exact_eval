      ...
      if (isset($_GET['criteria_id'])) {
        ...
        if ($connection) {
          ...
          if ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<h2 id=\"criteria_name\"> Criteria Name: <span id=\"editable_criteria_name\">{$row['criteria_name']}</span> <button class='edit' onclick=\"toggleEditCriteriaName()\"><i class=\"fa fa-edit\"></i></button></h2>";echo "<a href='criteria_list.php' class='back-button'><i class='fas fa-arrow-left'>&nbsp;&nbsp;Back</i></a>";
