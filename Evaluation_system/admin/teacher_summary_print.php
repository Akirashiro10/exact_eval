...
<body>
    ...
    <h3> Academic Year: &nbsp;<?php echo htmlspecialchars($academicYear);?>, <?php echo htmlspecialchars($semester2); ?> Semester <br><br>
            <h3 style="text-align:left">Faculty: &nbsp;<?php echo htmlspecialchars($faculty['Name']); ?></h3>
            <h3 style="text-align:right;margin-top:-20px;">Total Students Evaluated:&nbsp;&nbsp; <?php echo $student_count; ?> &nbsp;/ <?php echo $total_count; ?> (<?php echo round($student_count / $total_count * 100, 2); ?>%) </h3>
            </div><br>
            <table border="1">
                <thead>
                    <tr>
